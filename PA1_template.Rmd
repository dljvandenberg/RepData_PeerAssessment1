...
```{r setWorkDirAndUnzipDataAndReadCsv}
...
Recall the non-imputed versions of these statistics:
...
We conclude that linear imputation of missing data changes the mean value of total steps per day by `r mean.steps.per.day.imputed-mean.steps.per.day` and the median by `r median.steps.per.day.imputed-median.steps.per.day`.


## Are there differences in activity patterns between weekdays and weekends?

TODO: For this part the weekdays() function may be of some help here. Use the dataset with the filled-in missing values for this part.
